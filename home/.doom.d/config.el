...
(setq user-full-name "Arjan van der Gaag"
      user-mail-address "arjan@arjanvandergaag.nl")
...
(setq rubocop-autocorrect-command "rubocop -A --server --format emacs")
(setq-default window-combination-resize t)
(setq evil-want-fine-undo t)
(setq auto-save-default t)
(setq truncate-string-ellips "…")
...
(set-rotate-patterns! 'ruby-mode
  :symbols '(("describe" "context")
             ("let" "let!" "let_it_be")
...
(put 'rspec-use-bundler-when-possible 'safe-local-variable #'nilp)
